...
class PreflightRunner:
    ...
    CHECK_DEFINITIONS = [
        ...
        ("container", "Agent Sandbox Engine (Docker / Colima)", SystemProbes.check_container_runtime),
        ("kubernetes", "Connected Cloud Cluster (GKE / Kubectl)", SystemProbes.check_kubernetes_tooling),
        ("node", "Web & Frontend Tools (Node.js)", SystemProbes.check_node_tooling),
        ("network", "Cloud Connection & Memory Storage", SystemProbes.check_network_connectivity),
    ]
